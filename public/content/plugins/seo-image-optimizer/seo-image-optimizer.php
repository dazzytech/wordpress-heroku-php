...
define( 'WSIO_VERSION', '1.0.12'); // Plugin Version Number
...
function seo_settings_link($links) {
	...
	$seo_pro_link = '<a href="https://weblizar.com/plugins/seo-image-optimizer-pro/" target="_blank">Get Pro</a>';
    array_unshift($links, $seo_settings_link, $seo_pro_link);
    return $links;
}
